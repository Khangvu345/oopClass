...
public class J03021_DthCucGach {
    public static String transferByLogic(String str){
        ...
        for (char c: str.toCharArray()){ // Nhớ chỉ có thể lặp qua 1 mảng chứ không phải String
            switch (c){
                case 'A': case 'B': case 'C': res.append("2"); break;
                case 'D': case 'E': case 'F': res.append("3"); break;
                case 'G': case 'H': case 'I': res.append("4"); break;
                case 'J': case 'K': case 'L': res.append("5"); break;
                case 'M': case 'N': case 'O': res.append("6"); break;
                case 'P': case 'Q': case 'R': case 'S': res.append("7"); break;
                case 'T': case 'U': case 'V': res.append("8"); break;
                case 'W': case 'X': case 'Y': case 'Z': res.append("9"); break;
                default: break;
            }
        }
        return res.toString();
